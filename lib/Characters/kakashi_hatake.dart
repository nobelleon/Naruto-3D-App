...
import 'package:naruto_3d/Characters/Tenten.dart';

class KakashiHatake extends StatefulWidget {
  const KakashiHatake({super.key});

  @override
  State<KakashiHatake> createState() => _KakashiHatakeState();
}

class _KakashiHatakeState extends State<KakashiHatake>
        ...
        child: Stack(
          ...
          children: [
            ...
            Opacity(
              opacity: value + 0.5,
              child: Transform.scale(
                alignment: Alignment.bottomRight, // This Effect
                scale: 1 + frontTranslation,
                child: const FrontImage(),
              ),
            ),
