...
class Tenten extends StatefulWidget {
  const Tenten({super.key});

  @override
  State<Tenten> createState() => _TentenState();
}

class _TentenState extends State<Tenten> with SingleTickerProviderStateMixin {
