...
import 'package:naruto_3d/Characters/sakura_haruno.dart';

class NarutoUzumaki extends StatefulWidget {
  const NarutoUzumaki({super.key});

  @override
  State<NarutoUzumaki> createState() => _NarutoUzumakiState();
}

class _NarutoUzumakiState extends State<NarutoUzumaki>
