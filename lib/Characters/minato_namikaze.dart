...
import 'package:naruto_3d/Characters/kushina_uzumaki.dart';

class MinatoNamikaze extends StatefulWidget {
  const MinatoNamikaze({super.key});

  @override
  State<MinatoNamikaze> createState() => _MinatoNamikazeState();
}

class _MinatoNamikazeState extends State<MinatoNamikaze>
...
class Card3DEffect extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final frontTranslation = (value / 0.4) * 0.25;
    return SizedBox(
        ...
        child: Stack(
          ...
          children: [
            ...
            Opacity(
              opacity: value + 0.5,
              child: Transform.scale(
                alignment: Alignment.bottomLeft, // This Effect
                scale: 1 + frontTranslation,
                child: const FrontImage(),
              ),
            ),
